...
# Discussion
Sue's survavial probability without Leonardo on the board was `r Family_data_assumption[4,6]`, while with Leonardo, it was `r Family_data_assumption[2,6]`.
Sue's survavial probability without Leonardo on the board was `r Family_data_assumption[3,6]`, while with Leonardo, it was `r Family_data_assumption[1,6]`.
