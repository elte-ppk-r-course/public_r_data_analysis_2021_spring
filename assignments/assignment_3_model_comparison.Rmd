...
The complex model explained 42 % of variance. Sex, pain catastrophizing and cortisol saliva contributed significantely to the model
...
Based on AIC values, the complex model is a better fit to the data.

In conclusion, the complex model incremented in 35% its explanation of the variance compared to the simple model.