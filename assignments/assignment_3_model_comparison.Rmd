...
#we already see, that the sex variable has 1 woman type, while the others are female/male coded. We recode this value.
...
```{r}
#we run the cook's distance outlier removal several times, until we no longer find influential values.
pain_data_cleaned_outlierrm = cook_distance_remove(complex_model_nosaliva, pain_data_cleaned)
complex_model2 = lm(pain ~ age + sex + STAI_trait + pain_cat + mindfulness + cortisol_serum, pain_data_cleaned_outlierrm)

pain_data_cleaned_outlierrm2 = cook_distance_remove(complex_model2, pain_data_cleaned_outlierrm)
complex_model3 = lm(pain ~ age + sex + STAI_trait + pain_cat + mindfulness + cortisol_serum, pain_data_cleaned_outlierrm2)

pain_data_cleaned_outlierrm3 = cook_distance_remove(complex_model3, pain_data_cleaned_outlierrm2)
complex_model4 = lm(pain ~ age + sex + STAI_trait + pain_cat + mindfulness + cortisol_serum, pain_data_cleaned_outlierrm3)

pain_data_cleaned_outlierrm4 = cook_distance_remove(complex_model4, pain_data_cleaned_outlierrm3)
complex_model5 = lm(pain ~ age + sex + STAI_trait + pain_cat + mindfulness + cortisol_serum, pain_data_cleaned_outlierrm4)

pain_data_cleaned_outlierrm5 = cook_distance_remove(complex_model5, pain_data_cleaned_outlierrm4)
complex_model6 = lm(pain ~ age + sex + STAI_trait + pain_cat + mindfulness + cortisol_serum, pain_data_cleaned_outlierrm5)
```
