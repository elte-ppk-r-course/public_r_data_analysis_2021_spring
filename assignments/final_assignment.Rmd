...
car::ncvTest(model_age_end1)
car::spreadLevelPlot(model_age_end1)
...
car::ncvTest(model_age_end2)
car::spreadLevelPlot(model_age_end2)

#table output for the models
sjPlot:: tab_model(model_age_end1, model_age_end2, show.est = TRUE, show.fstat = TRUE, show.aic = TRUE)
```
...
sjPlot:: tab_model(model_forced_null, model_forced, show.est = TRUE, show.fstat = TRUE, show.aic = TRUE, show.loglik = TRUE)
...
sjPlot:: tab_model(model_battle_null, model_battle, show.est = TRUE, show.fstat = TRUE, show.aic = TRUE, show.loglik = TRUE)
...
sjPlot:: tab_model(model_natural_null, model_natural, show.est = TRUE, show.fstat = TRUE, show.aic = TRUE, show.loglik = TRUE)
```
